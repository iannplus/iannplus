...
### 📄 Обо мне:
Я — начинающий тестировщик с практическим опытом в функциональном, регрессионном и кроссбраузерном тестировании веб-приложений и REST API. Владею полным циклом QA: от составления чек-листов и тест-кейсов до проведения регресса, заведения баг-репортов и написания автотестов на Cypress и Python/Pytest. Имею опыт работы с Postman, Swagger, JMeter, Kibana, а также с системами контроля версий (Git) и баг-трекинга (Яндекс.Трекер). Стремлюсь развивать навыки в коммерческих проектах, учиться у опытных коллег и вносить весомый вклад в обеспечение качества продукта.
